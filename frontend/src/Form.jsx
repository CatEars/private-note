...
export const Form = (props) => {
    ...
    const secondsClasses = classNames('mx-auto flex-grow rounded outline-none', {
        'shadow-inline bg-gray-400': secondsSelected,
        'shadow bg-white': !secondsSelected
    });

    const hoursClasses = classNames('mx-auto flex-grow rounded outline-none ml-5 px-2 py-3', {
        'shadow-inline bg-gray-400': hoursSelected,
        'shadow bg-white': !hoursSelected
    });

    const daysClasses = classNames('mx-auto flex-grow rounded outline-none ml-5 px-2 py-3', {
    ...
    return (
        <div className="mx-auto my-4 flex flex-col w-2/3">
          ...
          <form className="flex flex-col my-4">
            ...
            >
              <button
                className={secondsClasses}
                onClick={onSecondSelect}
              >Seconds</button>

              <button
                className={hoursClasses}
                onClick={onHourSelect}
              >Hours</button>
            ...
            <label
              className="my-2"
              htmlFor="removalTime">Time until removed ({selectedConversion})</label>
